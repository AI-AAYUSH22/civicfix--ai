// ─────────────────────────────────────────────
//  CivicFix Shared API Client
//  Works in: browser (fetch), React Native (fetch), Node (Next.js server)
// ─────────────────────────────────────────────

import type { ApiCase, ApiWorkOrder, ApiVerificationResult, ApiStats } from './types';

export const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000/api/v1';
export const UPLOAD_BASE_URL = process.env.NEXT_PUBLIC_UPLOAD_BASE || 'http://localhost:8000';
